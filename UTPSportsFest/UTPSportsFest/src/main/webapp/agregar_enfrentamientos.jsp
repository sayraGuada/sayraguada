...
<%
    ...
    if ("POST".equals(request.getMethod())) {
        ...
        enfrentamientoDAO.insertarEnfrentamiento(fechaHora, equipoLocalID, equipoVisitanteID, deporteID, estado);

        // Redirige al usuario a "panel_de_control.jsp" después de la inserción
        System.out.println("Redirigiendo al panel de control"); // Agrega esto
...
<html>
    <head>
        ...
        <title>Agregar enfrentamientos | UTPSportsFest</title>
    </head>
    <body>
